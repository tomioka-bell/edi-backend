...
func SendModifyInvoiceVendorEmail(vendorCompany string,
	invoiceNumber string,
	fileURL string,
	note string,
	notificationType string) error {

	return emailclient.SendModifyInvoiceVendorEmail(vendorCompany, invoiceNumber, fileURL, note, notificationType)
...
// 	// ✅ HTML (formal tone) + index ถูกต้อง
// 	// %[1]s = invoiceNumber
// 	// %[2]s = vendorCompany
// 	// %[3]s = notificationType
// 	// %[4]s = link
// 	// %[5]s = remark
// 	// %[6]s = nowUTC
